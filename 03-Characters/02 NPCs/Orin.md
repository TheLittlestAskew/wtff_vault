---
type: npc
race: Crow (ghost/sprite appearance)
class: Familiar
...
- *(S02)* Displays no distress at being killed — entirely nonplussed.
...
## Abilities
- *(S02)* Immune to permanent death — dies and reforms immediately. Artie did not cast Find Familiar deliberately; the spell appears to be active permanently, possibly tied to the world's magical anomaly.
